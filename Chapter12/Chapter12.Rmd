...
## Figure 12-2
```{r Figure12_02, echo=echoChunks, results='show', message=TRUE, out.width = "800px", fig.width = 7.5}
```
...
## Figure 12-7
```{r Figure12_07, echo=echoChunks, results='show', message=TRUE, out.width = "800px", fig.width = 7.5}
```
