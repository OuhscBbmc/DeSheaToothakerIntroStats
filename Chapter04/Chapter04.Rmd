...
```
## Figure 4-6
```{r Figure04_06, echo=echoChunks, results='asis'}
```
## Figures4-7
```{r Figure04_07, echo=echoChunks, fig.height=3, fig.width=4.5, out.width="300px"}
```
## Figure 4-8
```{r Figure04_08, echo=echoChunks, fig.width=3.5, fig.height=1.5, out.width="350px"}
```
## Figure 4-9
