...
loaded via a namespace (and not attached):
 [1] Rcpp_0.12.3        Rttf2pt1_1.3.3     magrittr_1.5       munsell_0.4.2      colorspace_1.2-6   highr_0.5.1       
 [7] stringr_1.0.0.9000 tools_3.2.3        gtable_0.1.2       extrafontdb_1.0    htmltools_0.3      assertthat_0.1    
[13] yaml_2.1.13        digest_0.6.9       formatR_1.2.1      rsconnect_0.4.1.4  evaluate_0.8       rmarkdown_0.9.2   
[19] labeling_0.3       stringi_1.0-1     
```
