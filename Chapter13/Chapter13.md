...
<!-- ****** text object 44 ****** -->
<script id="NotUsed13_01vshader44" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_01fshader44" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 45 ****** -->
<script id="NotUsed13_01vshader45" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_01fshader45" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** text object 46 ****** -->
<script id="NotUsed13_01vshader46" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_01fshader46" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** text object 47 ****** -->
<script id="NotUsed13_01vshader47" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_01fshader47" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
gl.attachShader(prog43, getShader( gl, "NotUsed13_01vshader43" ));
gl.attachShader(prog43, getShader( gl, "NotUsed13_01fshader43" ));
//  Force aPos to location 0, aCol to location 1 
...
gl.attachShader(prog44, getShader( gl, "NotUsed13_01vshader44" ));
gl.attachShader(prog44, getShader( gl, "NotUsed13_01fshader44" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture44, document.getElementById("NotUsed13_01textureCanvas"));
var v=new Float32Array([
...
gl.attachShader(prog45, getShader( gl, "NotUsed13_01vshader45" ));
gl.attachShader(prog45, getShader( gl, "NotUsed13_01fshader45" ));
//  Force aPos to location 0, aCol to location 1 
...
gl.attachShader(prog46, getShader( gl, "NotUsed13_01vshader46" ));
gl.attachShader(prog46, getShader( gl, "NotUsed13_01fshader46" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture46, document.getElementById("NotUsed13_01textureCanvas"));
var v=new Float32Array([
...
gl.attachShader(prog47, getShader( gl, "NotUsed13_01vshader47" ));
gl.attachShader(prog47, getShader( gl, "NotUsed13_01fshader47" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture47, document.getElementById("NotUsed13_01textureCanvas"));
var v=new Float32Array([
...
var textScaleLoc47 = gl.getUniformLocation(prog47,"textScale");
// ****** text object 48 ******
var prog48  = gl.createProgram();
gl.attachShader(prog48, getShader( gl, "NotUsed13_01vshader48" ));
gl.attachShader(prog48, getShader( gl, "NotUsed13_01fshader48" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture48, document.getElementById("NotUsed13_01textureCanvas"));
var v=new Float32Array([
...
gl.uniform2f( textScaleLoc44, 0.001875, 0.001875);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0.4, 0.4, 0.4, 1 );
...
gl.uniform2f( textScaleLoc46, 0.001875, 0.001875);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0.4, 0.4, 0.4, 1 );
...
gl.uniform2f( textScaleLoc47, 0.001875, 0.001875);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
...
gl.uniform2f( textScaleLoc48, 0.001875, 0.001875);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0, 0, 0, 1 );
...
Your browser does not support the HTML5 canvas element.</canvas>
<!-- ****** surface object 60 ****** -->
<script id="NotUsed13_02vshader60" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_02fshader60" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 61 ****** -->
<script id="NotUsed13_02vshader61" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_02fshader61" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** text object 62 ****** -->
<script id="NotUsed13_02vshader62" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_02fshader62" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 63 ****** -->
<script id="NotUsed13_02vshader63" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_02fshader63" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** text object 64 ****** -->
<script id="NotUsed13_02vshader64" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_02fshader64" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** text object 65 ****** -->
<script id="NotUsed13_02vshader65" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_02fshader65" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** text object 66 ****** -->
<script id="NotUsed13_02vshader66" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="NotUsed13_02fshader66" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
var fov = new Object();
var userMatrix = new Object();
var activeSubscene = 49;
zoom[49] = 1;
fov[49] = 60;
userMatrix[49] = new CanvasMatrix4();
userMatrix[49].load([
1, 0, 0, 0,
0, 0.8191521, -0.5735765, 0,
0, 0.5735765, 0.8191521, 0,
...
gl.attachShader(prog60, getShader( gl, "NotUsed13_02vshader60" ));
gl.attachShader(prog60, getShader( gl, "NotUsed13_02fshader60" ));
//  Force aPos to location 0, aCol to location 1 
...
var normLoc60 = gl.getAttribLocation(prog60, "aNorm");
var f=new Uint16Array([
0, 26, 27, 0, 27, 1,
26, 52, 53, 26, 53, 27,
52, 78, 79, 52, 79, 53,
...
var normMatLoc60 = gl.getUniformLocation(prog60,"normMatrix");
// ****** lines object 61 ******
var prog61  = gl.createProgram();
gl.attachShader(prog61, getShader( gl, "NotUsed13_02vshader61" ));
gl.attachShader(prog61, getShader( gl, "NotUsed13_02fshader61" ));
//  Force aPos to location 0, aCol to location 1 
...
gl.attachShader(prog62, getShader( gl, "NotUsed13_02vshader62" ));
gl.attachShader(prog62, getShader( gl, "NotUsed13_02fshader62" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture62, document.getElementById("NotUsed13_02textureCanvas"));
var v=new Float32Array([
...
var textScaleLoc62 = gl.getUniformLocation(prog62,"textScale");
// ****** lines object 63 ******
var prog63  = gl.createProgram();
gl.attachShader(prog63, getShader( gl, "NotUsed13_02vshader63" ));
gl.attachShader(prog63, getShader( gl, "NotUsed13_02fshader63" ));
//  Force aPos to location 0, aCol to location 1 
...
gl.attachShader(prog64, getShader( gl, "NotUsed13_02vshader64" ));
gl.attachShader(prog64, getShader( gl, "NotUsed13_02fshader64" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture64, document.getElementById("NotUsed13_02textureCanvas"));
var v=new Float32Array([
...
gl.attachShader(prog65, getShader( gl, "NotUsed13_02vshader65" ));
gl.attachShader(prog65, getShader( gl, "NotUsed13_02fshader65" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture65, document.getElementById("NotUsed13_02textureCanvas"));
var v=new Float32Array([
...
gl.attachShader(prog66, getShader( gl, "NotUsed13_02vshader66" ));
gl.attachShader(prog66, getShader( gl, "NotUsed13_02fshader66" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture66, document.getElementById("NotUsed13_02textureCanvas"));
var v=new Float32Array([
...
var textScaleLoc66 = gl.getUniformLocation(prog66,"textScale");
gl.enable(gl.DEPTH_TEST);
gl.depthFunc(gl.LEQUAL);
gl.clearDepth(1.0);
gl.clearColor(1,1,1,1);
...
prMatrix.makeIdentity();
if (aspect > 1)
prMatrix.frustum(-hlen*aspect*zoom[49], hlen*aspect*zoom[49], 
-hlen*zoom[49], hlen*zoom[49], near, far);
else  
prMatrix.frustum(-hlen*zoom[49], hlen*zoom[49], 
-hlen*zoom[49]/aspect, hlen*zoom[49]/aspect, 
near, far);
mvMatrix.makeIdentity();
mvMatrix.translate( -0, -0, -0.988521 );
mvMatrix.scale( 1, 1, 1 );   
mvMatrix.multRight( userMatrix[49] );
mvMatrix.translate(-0, -0, -7.342254);
normMatrix.makeIdentity();
normMatrix.scale( 1, 1, 1 );   
normMatrix.multRight( userMatrix[49] );
// ****** surface object 60 *******
...
gl.uniformMatrix4fv( normMatLoc60, false, new Float32Array(normMatrix.getAsArray()) );
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0.4941176, 0.7450981, 0.6470588, 1 );
gl.enableVertexAttribArray( normLoc60 );
gl.vertexAttribPointer(normLoc60, 3, gl.FLOAT, false, 24, 12);
gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 24,  0);
gl.drawElements(gl.TRIANGLES, 3750, gl.UNSIGNED_SHORT, 0);
// ****** lines object 61 *******
...
gl.uniform2f( textScaleLoc62, 0.001875, 0.001875);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0.4, 0.4, 0.4, 1 );
...
gl.uniform2f( textScaleLoc64, 0.001875, 0.001875);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0.4, 0.4, 0.4, 1 );
...
gl.uniform2f( textScaleLoc65, 0.001875, 0.001875);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0, 0, 0, 1 );
...
gl.uniform2f( textScaleLoc66, 0.001875, 0.001875);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0, 0, 0, 1 );
...
var whichSubscene = function(coords){
if (0 <= coords.x && coords.x <= 400 && 0 <= coords.y && coords.y <= 400) return(49);
return(49);
}
var translateCoords = function(subsceneid, coords){
return {x:coords.x - vpx0[subsceneid], y:coords.y - vpy0[subsceneid]};
