...
```{r Figure12_02, echo=echoChunks, fig.width=4, out.width="400px"}
```
## Figure 12-3

```{r Figure12_03, echo=echoChunks, fig.width=4, out.width="400px"}
```
## Figure 12-4

```{r Figure12_04, echo=echoChunks, fig.width=4, out.width="400px"}
```

## Figure 12-5
```{r Figure12_05, echo=echoChunks, fig.width=7.5, out.width="750px"}
```
...
## Figure 12-9
```{r Figure12_09, echo=echoChunks,  fig.height = 2.5, fig.width=4, out.width="400px"}
```
...
## Figure 12-14
```{r Figure12_14, echo=echoChunks, fig.width=3.0, fig.height=2.0, out.width="300px"}
```
