...
## Figure 7-1
```{r figure-07-01, echo=echoChunks}
```

## Figure 7-2
```{r figure-07-02, echo=echoChunks, fig.width = 5.5, fig.height = 4/3, out.width="600px"}
```

## Figure 7-3
```{r figure-07-03, echo=echoChunks}
```

## Figure 7-4
```{r figure-07-04, echo=echoChunks, fig.width=4, fig.height=3, out.width="600px"}
```

## Figure 7-5
```{r figure-07-05, echo=echoChunks, fig.width=4, fig.height=3, out.width="600px"}
```

## Figure 7-6
```{r figure-07-06, echo=echoChunks}
```
